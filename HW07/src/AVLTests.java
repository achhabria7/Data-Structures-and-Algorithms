...
public class AVLTests {
    ...
    @Test(timeout = TIMEOUT)
    public void removeMissingElementException() {
        assertException(
                "Removing an element from an empty tree failed to throw a java.util.NoSuchElementException",
        ...
        assertException(
                "Removing an element not in the tree failed to throw a java.util.NoSuchElementException",
                java.util.NoSuchElementException.class,
                () -> avl.remove(8));
